...
function notiflixGoogleFont() {
	if (!document.getElementById("NotiflixQuicksand")) {
		...
		t.id = "NotiflixGoogleDNS",
		t.rel = "dns-prefetch",
		t.href = "//fonts.googleapis.com",
		document.head.appendChild(t);
		var e = document.createElement("link");
		e.id = "NotiflixQuicksand",
		e.rel = "stylesheet",
		e.href = "https://fonts.googleapis.com/css?family=Quicksand:300,400,500,700&amp;subset=latin-ext",
		document.head.appendChild(e)
	}
}
var Notiflix = {
	Notify: {
		Init: function(t) { (newNotifySettings = extendNotiflix(!0, notifySettings, t)).useGoogleFont && "Quicksand" === newNotifySettings.fontFamily && notiflixGoogleFont()
		},
		Merge: function(t) {
		...
		Success: function(t, e) {
			...
			"shadow" === newNotifySettings.fontAwesomeIconStyle && (n.fontAwesomeIconColor = n.background),
			NotiflixNotify(t, e, n, "success")
		},
		Failure: function(t, e) {
			e || (e = void 0);
			var n = newNotifySettings.failure;
			"shadow" === newNotifySettings.fontAwesomeIconStyle && (n.fontAwesomeIconColor = n.background),
			NotiflixNotify(t, e, n, "failure")
		},
		Warning: function(t, e) {
			e || (e = void 0);
			var n = newNotifySettings.warning;
			"shadow" === newNotifySettings.fontAwesomeIconStyle && (n.fontAwesomeIconColor = n.background),
			NotiflixNotify(t, e, n, "warning")
		},
		Info: function(t, e) {
			e || (e = void 0);
			var n = newNotifySettings.info;
			"shadow" === newNotifySettings.fontAwesomeIconStyle && (n.fontAwesomeIconColor = n.background),
			NotiflixNotify(t, e, n, "info")
		}
	},
	Report: {
		Init: function(t) { (newReportSettings = extendNotiflix(!0, reportSettings, t)).useGoogleFont && "Quicksand" === newReportSettings.fontFamily && notiflixGoogleFont()
		},
		Merge: function(t) {
	...
	Confirm: {
		Init: function(t) { (newConfirmSettings = extendNotiflix(!0, confirmSettings, t)).useGoogleFont && "Quicksand" === newConfirmSettings.fontFamily && notiflixGoogleFont()
		},
		Merge: function(t) {
	...
	Loading: {
		Init: function(t) { (newLoadingSettings = extendNotiflix(!0, loadingSettings, t)).useGoogleFont && "Quicksand" === newLoadingSettings.fontFamily && notiflixGoogleFont()
		},
		Merge: function(t) {
...
function NotiflixNotify(t, e, n, i) {
	if (null != arguments && 4 === arguments.length) {
		t || (t = "success" === i ? "Notiflix Success": "failure" === i ? "Notiflix Failure": "warning" === i ? "Notiflix Warning": "info" === i ? "Notiflix Info": "Notiflix"),
		newNotifySettings.plainText && (t = notiflixPlaintext(t)),
		!newNotifySettings.plainText && t.length > newNotifySettings.messageMaxLength && (Notiflix.Notify.Merge({
			closeButton: !0
		}), t = '<b>HTML Tags Error:</b> Your content length is more than "messageMaxLength" option.'),
		t.length > newNotifySettings.messageMaxLength && (t = t.substring(0, newNotifySettings.messageMaxLength) + "..."),
		notiflixNotifyCount++,
		...
		if (o.id = notifySettings.wrapID, o.style.width = newNotifySettings.width, o.style.zIndex = newNotifySettings.zindex, o.style.opacity = newNotifySettings.opacity, "right-bottom" === newNotifySettings.position ? (o.style.right = newNotifySettings.distance, o.style.bottom = newNotifySettings.distance, o.style.top = "auto", o.style.left = "auto") : "left-top" === newNotifySettings.position ? (o.style.left = newNotifySettings.distance, o.style.top = newNotifySettings.distance, o.style.right = "auto", o.style.bottom = "auto") : "left-bottom" === newNotifySettings.position ? (o.style.left = newNotifySettings.distance, o.style.bottom = newNotifySettings.distance, o.style.top = "auto", o.style.right = "auto") : (o.style.right = newNotifySettings.distance, o.style.top = newNotifySettings.distance, o.style.left = "auto", o.style.bottom = "auto"), newNotifySettings.backOverlay) {
			...
			s.id = newNotifySettings.ID + "Overlay",
			s.style.width = "100%",
			s.style.height = "100%",
			...
			s.style.right = 0,
			s.style.bottom = 0,
			s.style.background = newNotifySettings.backOverlayColor,
			s.className = newNotifySettings.cssAnimation ? "with-animation": "",
			s.style.animationDuration = newNotifySettings.cssAnimation ? newNotifySettings.cssAnimationDuration + "ms": "",
			document.getElementById(s.id) || a.appendChild(s)
		}
		document.getElementById(o.id) || a.appendChild(o);
		var r = document.createElement("div");
		r.id = newNotifySettings.ID + "-" + notiflixNotifyCount,
		r.className = newNotifySettings.className + " " + n.childClassName + " " + (newNotifySettings.cssAnimation ? "with-animation": "") + " " + (newNotifySettings.useIcon ? "with-icon": "") + " nx-" + newNotifySettings.cssAnimationStyle + " " + (newNotifySettings.closeButton && !e ? "with-close": "") + " " + (e ? "with-callback": ""),
		...
		newNotifySettings.rtl && (r.setAttribute("dir", "rtl"), r.classList.add("rtl-on")),
		newNotifySettings.useGoogleFont && (r.style.fontFamily = '"' + newNotifySettings.fontFamily + '", sans-serif'),
		newNotifySettings.cssAnimation && (r.style.animationDuration = newNotifySettings.cssAnimationDuration + "ms");
		var l, c = "";
		if (newNotifySettings.closeButton && !e && (c = '<span class="click-to-close"><svg class="clck2cls" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="20px" height="20px" version="1.1" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd"viewBox="0 0 20 20"xmlns:xlink="http://www.w3.org/1999/xlink"><defs><style type="text/css">.click2close{fill:' + n.notiflixIconColor + '}</style></defs><g><path class="click2close" d="M0.38 2.19l7.8 7.81 -7.8 7.81c-0.51,0.5 -0.51,1.31 -0.01,1.81 0.25,0.25 0.57,0.38 0.91,0.38 0.34,0 0.67,-0.14 0.91,-0.38l7.81 -7.81 7.81 7.81c0.24,0.24 0.57,0.38 0.91,0.38 0.34,0 0.66,-0.14 0.9,-0.38 0.51,-0.5 0.51,-1.31 0,-1.81l-7.81 -7.81 7.81 -7.81c0.51,-0.5 0.51,-1.31 0,-1.82 -0.5,-0.5 -1.31,-0.5 -1.81,0l-7.81 7.81 -7.81 -7.81c-0.5,-0.5 -1.31,-0.5 -1.81,0 -0.51,0.51 -0.51,1.32 0,1.82z"/></g></svg></span>'), newNotifySettings.useIcon) if (newNotifySettings.useFontAwesome) r.innerHTML = '<i style="color:' + n.fontAwesomeIconColor + "; font-size:" + newNotifySettings.fontAwesomeIconSize + ';" class="nmi wfa ' + n.fontAwesomeClassName + " " + ("shadow" === newNotifySettings.fontAwesomeIconStyle ? "shadow": "basic") + '"></i><span class="the-message with-icon">' + t + "</span>" + (newNotifySettings.closeButton ? c: "");
		...
		if (document.getElementById(r.id)) {
			...
			if (newNotifySettings.backOverlay && (u = document.getElementById(s.id)), newNotifySettings.closeButton || e || (w = setTimeout(function() {
				...
				newNotifySettings.backOverlay && h.childElementCount <= 0 && u.classList.add("remove")
			},
			newNotifySettings.timeout), y = setTimeout(function() {
				b.parentNode.removeChild(b),
				h.childElementCount <= 0 && (h.parentNode.removeChild(h), newNotifySettings.backOverlay && u.parentNode.removeChild(u))
			},
			newNotifySettings.timeout + newNotifySettings.cssAnimationDuration)), newNotifySettings.closeButton && !e) document.getElementById(r.id).querySelectorAll("span.click-to-close")[0].addEventListener("click",
			function() {
				b.classList.add("remove"),
				clearTimeout(w),
				newNotifySettings.backOverlay && h.childElementCount <= 1 && u.classList.add("remove"),
				setTimeout(function() {
					b.parentNode.removeChild(b),
					clearTimeout(y),
					h.childElementCount <= 0 && (h.parentNode.removeChild(h), newNotifySettings.backOverlay && u.parentNode.removeChild(u))
...
function NotiflixReport(t, e, n, i, a, o) {
	...
	newReportSettings.plainText || (t.length > newReportSettings.titleMaxLength && (t = "HTML Tags Error", e = 'Your Title content length is more than "titleMaxLength" option.', n = "Okay"), e.length > newReportSettings.messageMaxLength && (t = "HTML Tags Error", e = 'Your Message content length is more than "messageMaxLength" option.', n = "Okay"), n.length > newReportSettings.buttonMaxLength && (t = "HTML Tags Error", e = 'Your Button content length is more than "buttonMaxLength" option.', n = "Okay")),
	t.length > newReportSettings.titleMaxLength && (t = t.substring(0, newReportSettings.titleMaxLength) + "..."),
	e.length > newReportSettings.messageMaxLength && (e = e.substring(0, newReportSettings.messageMaxLength) + "..."),
	n.length > newReportSettings.buttonMaxLength && (n = n.substring(0, newReportSettings.buttonMaxLength) + "..."),
	...
	newReportSettings.useGoogleFont && (r.style.fontFamily = '"' + newReportSettings.fontFamily + '", sans-serif'),
	newReportSettings.rtl && (r.setAttribute("dir", "rtl"), r.classList.add("rtl-on"));
	var l = "";
	...
	if ("success" === o ? c = notiflixReportSvgSuccess(newReportSettings.svgSize, a.svgColor) : "failure" === o ? c = notiflixReportSvgFailure(newReportSettings.svgSize, a.svgColor) : "warning" === o ? c = notiflixReportSvgWarning(newReportSettings.svgSize, a.svgColor) : "info" === o && (c = notiflixReportSvgInfo(newReportSettings.svgSize, a.svgColor)), r.innerHTML = l + '<div class="' + newReportSettings.className + "-content" + (newReportSettings.cssAnimation ? " with-animation ": "") + " nx-" + newReportSettings.cssAnimationStyle + '" style="background:' + newReportSettings.backgroundColor + "; animation-duration:" + newReportSettings.cssAnimationDuration + 'ms;"><div style="width:' + newReportSettings.svgSize + "; height:" + newReportSettings.svgSize + ';" class="' + newReportSettings.className + '-icon">' + c + '</div><h5 class="' + newReportSettings.className + '-title" style="font-weight:500; font-size:' + newReportSettings.titleFontSize + "; color:" + a.titleColor + ';">' + t + '</h5><p class="' + newReportSettings.className + '-message" style="font-size:' + newReportSettings.messageFontSize + "; color:" + a.messageColor + ';">' + e + '</p><a id="NXReportButton" class="' + newReportSettings.className + '-button" style="font-weight:500; font-size:' + newReportSettings.buttonFontSize + "; background:" + a.buttonBackground + "; color:" + a.buttonColor + ';">' + n + "</a></div>", !document.getElementById(r.id)) {
		...
		document.getElementById("NXReportButton").addEventListener("click",
		function() {
			i && i(),
...
function NotiflixConfirm(t, e, n, i, a) {
	newConfirmSettings.plainText && (t = notiflixPlaintext(t), e = notiflixPlaintext(e), n = notiflixPlaintext(n), i = notiflixPlaintext(i)),
	newConfirmSettings.plainText || (t.length > newConfirmSettings.titleMaxLength && (t = "HTML Tags Error", e = 'Your Title content length is more than "titleMaxLength" option.', n = "Okay", i = "..."), e.length > newConfirmSettings.messageMaxLength && (t = "HTML Tags Error", e = 'Your Message content length is more than "messageMaxLength" option.', n = "Okay", i = "..."), (n.length || i.length) > newConfirmSettings.buttonsMaxLength && (t = "HTML Tags Error", e = 'Your Buttons contents length is more than "buttonsMaxLength" option.', n = "Okay", i = "...")),
	t.length > newConfirmSettings.titleMaxLength && (t = t.substring(0, newConfirmSettings.titleMaxLength) + "..."),
	e.length > newConfirmSettings.messageMaxLength && (e = e.substring(0, newConfirmSettings.messageMaxLength) + "..."),
	n.length > newConfirmSettings.buttonsMaxLength && (n = n.substring(0, newConfirmSettings.buttonsMaxLength) + "..."),
	i.length > newConfirmSettings.buttonsMaxLength && (i = i.substring(0, newConfirmSettings.buttonsMaxLength) + "..."),
	newConfirmSettings.cssAnimation || (newConfirmSettings.cssAnimationDuration = 0);
	var o = document.getElementsByTagName("body")[0],
	s = document.createElement("div");
	s.id = confirmSettings.ID,
	s.className = newConfirmSettings.className + (newConfirmSettings.cssAnimation ? " with-animation nx-" + newConfirmSettings.cssAnimationStyle: ""),
	s.style.width = newConfirmSettings.width,
	s.style.zIndex = newConfirmSettings.zindex,
	newConfirmSettings.rtl && (s.setAttribute("dir", "rtl"), s.classList.add("rtl-on")),
	newConfirmSettings.useGoogleFont && (s.style.fontFamily = '"' + newConfirmSettings.fontFamily + '", sans-serif');
	var r = "";
	...
	if (a && (l = '<a id="NXConfirmButtonCancel" class="confirm-button-cancel" style="color:' + newConfirmSettings.cancelButtonColor + ";background:" + newConfirmSettings.cancelButtonBackground + ";font-size:" + newConfirmSettings.buttonsFontSize + ';">' + i + "</a>"), s.innerHTML = r + '<div class="' + newConfirmSettings.className + '-content" style="background:' + newConfirmSettings.backgroundColor + "; animation-duration:" + newConfirmSettings.cssAnimationDuration + "ms; border-radius: " + newConfirmSettings.borderRadius + ';"><div class="' + newConfirmSettings.className + '-head"><h5 style="color:' + newConfirmSettings.titleColor + ";font-size:" + newConfirmSettings.titleFontSize + ';">' + t + '</h5><p style="color:' + newConfirmSettings.messageColor + ";font-size:" + newConfirmSettings.messageFontSize + ';">' + e + '</p></div><div class="' + newConfirmSettings.className + '-buttons"><a id="NXConfirmButtonOk" class="confirm-button-ok' + (a ? "": " full") + '" style="color:' + newConfirmSettings.okButtonColor + ";background:" + newConfirmSettings.okButtonBackground + ";font-size:" + newConfirmSettings.buttonsFontSize + ';">' + n + "</a>" + l + "</div></div>", !document.getElementById(s.id)) {
		...
		document.getElementById("NXConfirmButtonCancel").addEventListener("click",
		function() {
			p.classList.add("remove"),
			setTimeout(function() {
				p.parentNode.removeChild(p)
...
function NotiflixLoading(t, e, n, i) {
	if (n) {
		...
		if ("standard" === e) l = notiflixLoadingSvgStandard(newLoadingSettings.svgSize, newLoadingSettings.svgColor);
			...
			if ("custom" === e && null == newLoadingSettings.customSvgUrl) return console.error('Notiflix Error: You have to set a static SVG url to "customSvgUrl" option for use Loading Custom.'),
			!1;
